...
+------------------------------+------------------------+----------------------------------+
| Error messages               | Walls of substitution  | "T does not satisfy Hashable"    |
|                              | failures               |                                  |
+------------------------------+------------------------+----------------------------------+
| Overload resolution          | SFINAE removes from    | Subsumption picks most specific  |
|                              | set; no ordering       |                                  |
+------------------------------+------------------------+----------------------------------+
| Constraint visibility        | Hidden in template     | Named, documentable, reusable    |
|                              | parameter list         |                                  |
+------------------------------+------------------------+----------------------------------+
