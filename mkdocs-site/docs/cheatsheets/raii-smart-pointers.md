...
# :material-book: Raii Smart Pointers
...
Ownership models, unique_ptr / shared_ptr / weak_ptr mechanics, non-owning views, ownership transfer patterns, and memory bugs RAII prevents.
...
**Rule:** every resource has exactly one owner at a time. Non-owners must not outlive the owner.
