...
# :material-alert: 04 — Pitfalls: Performance Tips OOP
...
??? pitfall-lobe "⚠️ Pitfall 1 — Optimising Without Profiling"
...
??? pitfall-lobe "⚠️ Pitfall 2 — Storing Polymorphic Objects by Value in a `std::vector`"
...
??? pitfall-lobe "⚠️ Pitfall 3 — Cache Miss from Indirection in Tight Loops"
...
??? pitfall-lobe "⚠️ Pitfall 4 — Calling Virtual Functions Inside a SIMD-Able Loop"
...
??? pitfall-lobe "⚠️ Pitfall 5 — Using `std::function` in a Performance-Critical Hot Path"
...
??? pitfall-lobe "⚠️ Pitfall 6 — Misapplying `[[likely]]`/`[[unlikely]]`"
...
Use this before pushing code from Day 22:
