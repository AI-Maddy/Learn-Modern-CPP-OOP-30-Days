...
# :material-eye: 01 — Intuition: Mini Project 2 Shape Editor
...
??? question "❓ Why does C++ need Mini Project 2 Shape Editor?"
    Think about what problem this solves before reading the answer below.

    The shape editor teaches you how to choose between four modern C++ patterns for the same problem: virtual dispatch, the Visitor pattern, std::variant, and factory + std::ranges. Knowing when to reach for each tool separates intermediate C++ programmers from seniors.
...
!!! tip "💡 Real-World Analogy"
    Think of **Mini Project 2 Shape Editor** like a well-designed tool in a workshop:
...
??? abstract "🟣 Lock It In"
    ...
    **"Mini Project 2 Shape Editor** is the way C++ lets you..." — finish the sentence in your own words.
