...
# :material-eye: 01 — Intuition: Templates Basics
...
??? question "❓ Why does C++ need Templates Basics?"
...
!!! tip "💡 Real-World Analogy"
    Think of **Templates Basics** like a well-designed tool in a workshop:
...
??? abstract "🟣 Lock It In"
    ...
    **"Templates Basics** is the way C++ lets you..." — finish the sentence in your own words.
