...
* `move-semantics-gotchas.rst` — std::move, NRVO, moved-from state
* `raii-smart-pointers.rst` — unique_ptr as Rule-of-Zero enabler
* `classes-constructors-raii.rst` — constructor mechanics
* `inheritance-polymorphism.rst` — virtual destructor interaction
